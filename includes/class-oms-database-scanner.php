 ...
 *
 * Scans WordPress database tables for malicious content and integrity issues.
 */
class OMS_Database_Scanner {
	...
	public function __construct(
		...
		$this->cleaner = null !== $cleaner ? $cleaner : new OMS_Database_Cleaner( $this->logger, $this->wpdb );
	}
